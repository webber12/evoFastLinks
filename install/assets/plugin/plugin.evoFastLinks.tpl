 ...
 * @internal    @properties &ids=Список id ресурсов через запятую;text;&tabname=Название пункта в верхнем меню;text;Быстрые ссылки&hidefromtree=Скрывать непапки из дерева;text;0
